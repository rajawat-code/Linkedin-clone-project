    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Or{' '}
          <Link to="/register" className="font-semibold text-linkedin-blue hover:text-linkedin-blue-hover hover:underline">
            join LinkedIn today
          </Link>
        </p>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link to="/forgot-password" className="font-semibold text-linkedin-blue hover:text-linkedin-blue-hover hover:underline">
                  Forgot password?
                </Link>
              </div>
            </div>
